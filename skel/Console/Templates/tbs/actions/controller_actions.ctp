...
<?php if ($wannaUseSession): ?>
				$this->Session->setFlash(__('The <?php echo strtolower($singularHumanName); ?> could not be saved. Please, try again.'),'alert',array('class'=>'error'));
<?php endif; ?>
			}
		}
<?php
...
<?php if ($wannaUseSession): ?>
			$this->Session->setFlash(__('<?php echo ucfirst(strtolower($singularHumanName)); ?> deleted'),'alert',array('class'=>'success'));
...
<?php if ($wannaUseSession): ?>
		$this->Session->setFlash(__('<?php echo ucfirst(strtolower($singularHumanName)); ?> was not deleted'),'alert',array('class'=>'erorr'));
<?php else: ?>
		$this->flash(__('<?php echo ucfirst(strtolower($singularHumanName)); ?> was not deleted'), array('action' => 'index'),'alert',array('class'=>'error'));
<?php endif; ?>
		$this->redirect(array('action' => 'index'));
	}